# Contributing to base-search

First and foremost, thank you! We appreciate that you want to contribute to base-search, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for base-search**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for base-search:

- star the [project](https://github.com/node-base/base-search)
- tweet your support for base-search
...
- **version**: please note the version of base-search are you using
...
[so]: http://stackoverflow.com/questions/tagged/base-search